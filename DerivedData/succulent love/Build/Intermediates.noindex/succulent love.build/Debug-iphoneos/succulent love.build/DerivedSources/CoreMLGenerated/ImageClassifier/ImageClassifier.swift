...
class ImageClassifierInput : MLFeatureProvider {
...
@available(macOS 10.13, iOS 11.0, tvOS 11.0, watchOS 4.0, *)
class ImageClassifierOutput : MLFeatureProvider {
...
/// URL of model assuming it was installed in the same bundle as this class
    ...
    */
    func prediction(input: ImageClassifierInput) throws -> ImageClassifierOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as ImageClassifierOutput
    */
    func prediction(input: ImageClassifierInput, options: MLPredictionOptions) throws -> ImageClassifierOutput {
    ...
    */
    @available(macOS 10.14, iOS 12.0, tvOS 12.0, watchOS 5.0, *)
    func predictions(inputs: [ImageClassifierInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [ImageClassifierOutput] {
